...
public enum Chain {
    ...
    public static Chain getChain(String chainName){
        if ((chainName.equals(Chain.HSN_DEV.getChain())) || (chainName.equals(Chain.HSN_TEST.getChain())) ||  (chainName.equals(Chain.HSN_MAIN.getChain()))){
            return HSN_MAIN;
        }
        return HSN_MAIN;
    }
